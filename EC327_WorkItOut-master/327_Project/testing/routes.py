...
from testing import app, db, bcrypt, mail
from testing.forms import RegistrationForm, LoginForm, RequestResetForm, ResetPasswordForm, UpdateAccountForm, PostForm
...
def save_picture(form_picture):
    ...
    #image resizing for space saving
    output_size = (125,125)
